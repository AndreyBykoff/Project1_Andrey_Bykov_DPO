...
ROOMS = {
    'entrance': {
        'description': 'Вы в темном входе лабиринта. Стены '
...
COMMANDS = {
  ...
  "look" : "Просмотр текущей комнаты",
  "inventory" : "Просмотр инвенторя",
  "solve" : "Отгадать загадку",
  "open" : "Открыть сундук с сокровищами",
  "openIt" : "Открыть дверь в комнату с сокровищами",
